...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5),
	    ...
	    projectData = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(5);
	var CVM = __webpack_require__(198);
	var VisibilitySensor = __webpack_require__(199);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  var React = typeof window !== 'undefined' && window.React || __webpack_require__(5);

	  var RATE_LIMIT = 25;

	  var ComponentVisibilityMixin = {
	    setComponentVisbilityRateLimit: function setComponentVisbilityRateLimit(milliseconds) {
	     ...
	     */
	    checkComponentVisibility: function checkComponentVisibility() {
	     ...
	     */
	    enableVisbilityHandling: function enableVisbilityHandling(checkNow) {
	      if (typeof window === "undefined") {
	     ...
	     */
	    disableVisbilityHandling: function disableVisbilityHandling() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  check: function check() {
	    ...
	    var partialVertical = rect.top >= containmentRect.top && rect.top <= containmentRect.bottom || rect.bottom >= containmentRect.top && rect.bottom <= containmentRect.bottom;
	    ...
	    var isVisible = this.props.partialVisibility ? partialVisible : fullVisible;
	  ...
	  render:function() {
	    return (
	      React.createElement("div", {className: "search-component"}, 
	        ...
	        React.createElement("p", null, React.createElement("span", null, "You are a giant turnip: ", this.state.search))
	      )
	    );
	  },
